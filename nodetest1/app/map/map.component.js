System.register(["angular2/core", 'angular2-google-maps/core', "angular2/http", "../my-map-control.component", "angular2/router"], function(exports_1) {
    ...
    var core_1, core_2, http_1, my_map_control_component_1, router_1;
    var MapComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            MapComponent = (function () {
                function MapComponent(_http, _router) {
                    this._http = _http;
